...
type Props = {
  title: string;
  setItem: React.Dispatch<React.SetStateAction<string | null | undefined>>;
...
export default function InputComponent({ title, setItem, setColor1, setColor2, setColor3 }: Props) {
    return (
      <InputBox>
        <InputText>{title}</InputText>
        <Input keyboardType="numeric" placeholder="30Ω" onChangeText={(e) => ohmsToColor({value: parseInt(e), setColor1: setColor1, setColor2: setColor2, setColor3: setColor3})}/>
      </InputBox>
    );
}
